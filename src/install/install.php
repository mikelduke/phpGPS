<?php
  ...
  function install($con) {
    ...
    $query = "CREATE TABLE IF NOT EXISTS gps_owner (
    ...
    $query = "CREATE TABLE IF NOT EXISTS gps_device (
    ...
    $query = "CREATE TABLE IF NOT EXISTS gps_type (
    ...
    $query = "CREATE TABLE IF NOT EXISTS gps_path (
    ...
    $query = "CREATE TABLE IF NOT EXISTS gps_entries (
