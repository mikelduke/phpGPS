...
<?php if($loginT != null && $loginT->getStatus() == true) { ?>
  ...
  <hr />
  <a href="addGpsEntry.php?newEntry=Y">Test Update</a><br />
  <a href="addGpsEntry.php?newEntry=Y&gps_device_id=1&gps_type_id=1&gps_path_id=1&gps_date_dt=11-13-2014&gps_date_time=22.31&gps_status=&gps_latitude=32.86181604&gps_longitude=-96.76354452&gps_altitude=160.0&gps_accuracy=57&gps_name=test spot&gps_comment=test comment&gps_address1=address 1&gps_address2=address 2&gps_address3=address 3&gps_city=city&gps_zipcode=567567&gps_state=state&gps_country=country">Test Update with Info</a><br />
  <a href="updateRecord.php?update=true&table=gps_entries&where=gps_entry_id=3&gps_latitude=27.86181641">Test Update Record</a><br />
<?php } ?>
